...
// Set the timezone based on the subdomain
if (SUBDOMAIN === 'eyd') {
...
// $config['base_url'] = $is_production ? 'https://letslearneasy.com/' : 'https://loving-crayfish-brief.ngrok-free.app/franhive_revamp/';
//live
// $config['base_url'] = 'https://www.franhive.com/eyd';
// $config['base_url'] = 'https://' . $_SERVER['HTTP_HOST'] . '/';

//local
// $config['base_url'] = 'http://localhost/franhive_revamp/';
...
*/
$config['proxy_ips'] = '';
// $config['sender_email'] = 'aakash962002@gmail.com';
