...
<div class="main-container">
    <div class="pd-ltr-20 xs-pd-20-10">
        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form action="<?= base_url('ClientController/createClient') ?>" method="post">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="STORE_ID" placeholder="Client ID" required />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="STORE_NAME" placeholder="Client Name" required />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="TEAMS_LINK" placeholder="https://teams.microsoft.com/..." />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="TEAMS_PASSWORD" placeholder="Teams password" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select id='multi_courses_ids' class="custom-select col-12" name="COURSE_ID[]" >
                    ...
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="LINKEDIN_LINK" placeholder="Website"  />
                            </div>
                        </div>
                    </div>
                </div>
                <div class="form-group row">
                    <div class="col-md-6 offset-md-2">
                        <button type="submit" class="btn btn-warning">Add Client</button>
                    </div>
                </div>
            </form>
        </div>
