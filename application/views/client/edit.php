                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="TEAMS_LINK" placeholder="https://teams.microsoft.com/..." value="<?= htmlspecialchars($client_data['TEAMS_LINK'] ?? '') ?>" />
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="TEAMS_PASSWORD" placeholder="Teams password" value="<?= htmlspecialchars($client_data['TEAMS_PASSWORD'] ?? '') ?>" />
                            </div>
                        </div>
                    </div>
                </div>
