    ...
    sel.addEventListener('change', async function () {
        ...
        try {
            ...
            fields.forEach((f) => {
                ...
                td1.innerHTML = `<input class="form-control" name="field_name[]" value="${f.name}" readonly>`;

                const td2 = document.createElement('td');
                td2.textContent = f.label;

                const td3 = document.createElement('td');
                td3.innerHTML = `<input class="form-control" name="field_label_override[]" value="${f.label}">`;
