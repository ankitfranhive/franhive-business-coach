    ...
    <div class="section">
        ...
        <table class="grid">
            <tr>
                ...
                <td><div class="label">Signed at</div><div class="value"><?= pdfv($this->Payment_agreement_model->format_signature_datetime($agreement['signature_date'] ?? '', $agreement['client_timezone'] ?? '')) ?></div></td>
            </tr>
        </table>
